...
import com.mycompany.proyectov2.dao.AlumnoDAO;
...
public class AgregarAlumnoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AgregarAlumnoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
@Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        nuevoAlumno.setClase(clase);

        alumnoDAO.guardar(nuevoAlumno);

        response.sendRedirect("verClase?idClase=" + idClase);
    }
